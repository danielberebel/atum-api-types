...
export interface InventoryAtumInterface {
  ...
  region: Record<number, string>; // If the region restriction mode is enabled, it'll show the list of countries or shipping zones linked to the inventory.
  location: Record<number, string>; // ATUM Location(s) linked to the inventory.
...
export interface InventoryQueryParamsAtumInterface
  extends ProductInventoryQueryParamsAtumInterface {
