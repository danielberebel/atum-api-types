...
import { BomAtumInterface, MultiInventoryAtumInterface } from './inventory-atum.interface';
...
// MetaData
export interface PurchaseOrderMetaDataAtumInterface extends MetaDataAtumInterface {
    id?: number; // READ-ONLY
    key: string;
    value: string;
}
...
// FeeLine
export interface PurchaseOrderFeeLineAtumInterface extends FeeLineAtumInterface {
    id?: number; // READ-ONLY
    name?: string;
    tax_class?: string;
    tax_status?: string;
...
// TaxLine
export interface PurchaseOrderTaxLineAtumInterface extends TaxLineAtumInterface {
    id?: number; // READ-ONLY
...
// ShippingLine
export interface PurchaseOrderShippingLineAtumInterface extends ShippingLineAtumInterface {
    id?: number; // READ-ONLY
    method_title?: string;
    method_id?: string;
    total: string; // 	Line total (after discounts).
...
// LineItem
export interface PurchaseOrderLineItemAtumInterface extends LineItemAtumInterface {
    // LineItem
    id?: number; // READ-ONLY
    name?: string;
    product_id?: number;
