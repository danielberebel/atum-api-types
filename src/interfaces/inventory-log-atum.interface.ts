...
// LineItem
export interface InventoryLogLineItemAtumInterface
...
// ShippingLine
export interface InventoryLogShippingLineAtumInterface
...
// MetaData
export interface InventoryLogMetaDataAtumInterface
...
// MultiInventory
export interface InventoryLogMultiInventoryAtumInterface
  extends MultiInventoryAtumInterface {
  id?: number;
