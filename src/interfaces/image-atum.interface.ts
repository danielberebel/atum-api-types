import { ImageWcInterface } from '../wc';

type OmitProperties = 'date_created' | 'date_created_gmt' | 'date_modified' | 'date_modified_gmt';

export interface ImageAtumInterface extends Partial<Omit<ImageWcInterface, OmitProperties>> {
    id: number;
    name: string;
    slug: string;
