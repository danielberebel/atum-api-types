import { SettingOptionWcInterface, SettingsGroupWcInterface, SettingsWcInterface } from '../wc/setting-wc.interface';
...
export interface StoreSettingsAtumInterface extends SettingsAtumInterface, OnlineItemInterface {}
